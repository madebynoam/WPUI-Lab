    ...
    propDefinitions: [
      ...
      },
      {
        ...
        options: [
          ...
          'content-error-weak',
          'content-success',
          'content-success-weak',
          'content-caution',
          'content-caution-weak',
          'content-info',
          'content-info-weak',
          'content-warning',
          'content-warning-weak',
          'interactive-brand',
          'interactive-brand-active',
          'interactive-brand-disabled',
          'interactive-brand-strong',
          'interactive-brand-strong-active',
          'interactive-brand-strong-disabled',
          'interactive-neutral',
          'interactive-neutral-active',
          'interactive-neutral-disabled',
          'interactive-neutral-strong',
          'interactive-neutral-strong-active',
          'interactive-neutral-strong-disabled',
          'interactive-neutral-weak',
          'interactive-neutral-weak-disabled',
        ],
        defaultValue: 'default',
